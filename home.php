  ...
  <section class="benefits">
    <div class="container">
      <div class="benefits__inner">
        <img data-wow-delay="2s" class="benefits__images wow animate__fadeInUp" src="<?php the_field('avto-img');?>" alt="car">
    ...
    <div class="container">
      <div class="contacts__inner">
        ...
        <form class="contacts__form">
          ...
          <?php echo do_shortcode('[contact-form-7 id="fa19d67" title="Контактная форма"]') ?>
        </form>
      </div>
    </div>
  </section>
